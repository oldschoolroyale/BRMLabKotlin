...
class UpdatePharmacyFragment : MvpAppCompatFragment(), UpdateDoctor {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when(item.itemId){
            ...
            R.id.stock_update_pharmacy_menu -> findNavController().navigate(UpdatePharmacyFragmentDirections.actionUpdatePharmacyFragmentToOrderFragment(
                id = args.id,
                user = user!!
            ))
            R.id.order_update_pharmacy_menu -> findNavController().navigate(UpdatePharmacyFragmentDirections.actionUpdatePharmacyFragmentToStockFragment(
                    id = args.id,
                    user = user!!
            ))
